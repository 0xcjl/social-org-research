...
| 调研商业产品或 B2B SaaS 公司 | ❌ 用 [`market-research`](https://github.com/0xcjl/market-research) 替代 |
| 学术论文文献综述 | ❌ 用 [`academic-research`](https://github.com/0xcjl/academic-research) 替代 |
| 跨多家做行业趋势研究 | ❌ 用 [`deep-research`](https://github.com/0xcjl/deep-research) 替代 |
